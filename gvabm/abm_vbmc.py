...
def get_param_density_func_noisy(sample_func, param_distr, log_prior, rngkey, num_samples, cutoff_likelihood=-1100, logdir=None):
    ...
    def param_density_func(params):
        ...
        city_eval = eval_ds(subsampled_city_data, params, 50, subkey, num_samples=num_samples, sample_func=sample_func)
        ...
        if(res < cutoff_likelihood):
            return cutoff_likelihood + likelihood_offset, 3
        return float(res + likelihood_offset), 1.2 #VBMC expects a tuple of (value, noise)
