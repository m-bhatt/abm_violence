...
with open(f'{data_dir}/processed/subsampled_city_data.pkl', 'rb') as f:
    ...
    subsampled_city_data_names = subsampled_data['subsampled_city_names']
    subsampled_city_data = subsampled_data['subsampled_city_data']
    subsample_weights = subsampled_data['subsample_weights']

    city_data = subsampled_data['city_data']
