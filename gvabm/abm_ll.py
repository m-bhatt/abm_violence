...
from gvabm.stat_utils import grenander_pdf, EmpiricalCDF, hybrid_pdf
from gvabm.abm_event import conditional_sample

def city_ll(city_params, event_list, general_params, timespan, event_distr, report_threshold=5.0):
    ...
    prob_event = 1-event_distr.cdf(report_threshold)
